...
class Evaluation:
    def __init__(self, train_data, test_data, tensorFlow_training_duration, tensorFlow_training_error, tensorFlow_test_duration, tensorFlow_test_error, tensorFlow_y_pred, 
    ...
    def plot(self):
        ...
        axs1.text(.95, 0.05, ("Error: " + str(self.tensorFlow_test_error)), ha='right', va='bottom', transform=axs1.transAxes, bbox=dict(boxstyle = "square", facecolor = "white", alpha = 0.5))
        axs2.text(.95, 0.05, ("Error: " + str(self.linearRegression_test_error)), ha='right', va='bottom', transform=axs2.transAxes, bbox=dict(boxstyle = "square", facecolor = "white", alpha = 0.5))
        axs3.text(.95, 0.05, ("Error: " + str(self.decisionTree_test_error)), ha='right', va='bottom', transform=axs3.transAxes, bbox=dict(boxstyle = "square", facecolor = "white", alpha = 0.5))
        axs4.text(.95, 0.05, ("Error: " + str(self.randomForest_test_error)), ha='right', va='bottom', transform=axs4.transAxes, bbox=dict(boxstyle = "square", facecolor = "white", alpha = 0.5))
        ...
        plt.scatter(self.tensorFlow_training_error, self.tensorFlow_training_duration, s=120, c='blue', alpha=0.6)
        plt.scatter(self.tensorFlow_test_error, self.tensorFlow_test_duration, s=120, c='blue', alpha=0.6, marker='v')
        plt.scatter(self.linearRegression_training_error, self.linearRegression_training_duration, s=120, c='red', alpha=0.6)
        plt.scatter(self.linearRegression_test_error, self.linearRegression_test_duration, s=120, c='red', alpha=0.6, marker='v')
        plt.scatter(self.decisionTree_training_error, self.decisionTree_training_duration, s=120, c='green', alpha=0.6)
        plt.scatter(self.decisionTree_test_error, self.decisionTree_test_duration, s=120, c='green', alpha=0.6, marker='v')
        plt.scatter(self.randomForest_training_error, self.randomForest_training_duration, s=120, c='orange', alpha=0.6)
        plt.scatter(self.randomForest_test_error, self.randomForest_test_duration, s=120, c='orange', alpha=0.6, marker='v')
